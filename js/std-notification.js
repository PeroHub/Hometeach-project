...
// set color for the whole site from storage
  document.addEventListener('DOMContentLoaded', function(){
    ...
    const picture = document.querySelector('.notification-img');
    if(myColor === "#D2492F" ){picture.src = "./images/std-notify-img-red.jpg"}    
    else if(myColor === "#3E8A23" ){picture.src = "./images/std-notify-img-green.jpg"}  
    else if(myColor === "#C09728" ){picture.src = "./images/std-notify-img-yellow.jpg"}
    else{picture.src = "./images/std-notify-img-green.jpg"}
  })
