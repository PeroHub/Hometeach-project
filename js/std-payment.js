...
// set color for the whole site from storage
  document.addEventListener('DOMContentLoaded', function(){
    ...
    const picture = document.querySelector('.payment-img');
    if(myColor === "#D2492F" ){picture.src = "./images/std-payment-img-red.jpg"}    
    else if(myColor === "#3E8A23" ){picture.src = "./images/std-payment-img-green.jpg"}  
    else if(myColor === "#C09728" ){picture.src = "./images/std-payment-img-yellow.jpg"}
    else{picture.src = "./images/std-payment-img-green.jpg"}     
